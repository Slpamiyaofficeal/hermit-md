...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || '06_28_H_E_R_M_I_T_P4_SYPI',
    ...
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? true : process.env.BLOCK_CHAT,
    ...
    BOT_INFO: process.env.BOT_INFO || 'ʜᴇʀᴍɪᴛ;ηιкσ;94704020146;https://i.imgur.com/X3KCHB6.jpeg',

    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'ʜᴇʀᴍɪᴛ;ᴀᴅɪᴛʜyᴀɴ;https://i.imgur.com/X3KCHB6.jpeg' : process.env.AUDIO_DATA,
